...
@Component({
  selector: 'app-model-followings',
  templateUrl: './model-followings.component.html',
  styleUrls: ['./model-followings.component.css']
})
export class ModelFollowingsComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    setTimeout(() => {
      ...
      this.followingDetailsFn('model_followings_list', details);
    }, 2000);
  }
...
showMoreFollowings() {
    this.followingDetailsFn('model_followings_list', {skip : this.followingsSkipCount,username:this.username,reference:'modelToModelProfileView'});
}
