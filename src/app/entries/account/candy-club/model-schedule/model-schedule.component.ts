...
declare var $: any ;
@Component({
  selector: 'app-model-schedule',
  templateUrl: './model-schedule.component.html',
  styleUrls: ['./model-schedule.component.css']
})
export class ModelScheduleComponent implements AfterViewInit {
  ...
  modelSchedule(form : NgForm){
    ...
    .subscribe((data : any ) => {
        ...
        if (data.success == true) {
          $.toast({
            heading: 'Success',
            text: "Model Schedule has been updated successfully",
            // icon: 'error',
            position: 'top-right',
            stack: false,
            textAlign: 'left',
